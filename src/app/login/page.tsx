      ...
      >
        ...
        <label className="flex flex-col gap-1 text-sm text-zinc-700 dark:text-zinc-300">
          ...
          <input
            ...
            required
            autoComplete="email"
            className="rounded border border-black/15 bg-transparent px-3 py-2 text-black outline-none focus:border-black/40 dark:border-white/15 dark:text-zinc-50"
          />
        </label>
